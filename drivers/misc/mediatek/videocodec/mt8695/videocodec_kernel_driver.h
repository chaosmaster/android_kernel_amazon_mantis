...
#define VCODEC_LAT_LOCKHW                           _IOW(MFV_IOC_MAGIC, 0x35, unsigned int)	/* VAL_HW_LOCK_T * */

#define VCODEC_LAT_UNLOCKHW                         _IOW(MFV_IOC_MAGIC, 0x36, unsigned int)
#define VCODEC_WAIT_LAT_ISR                          _IOW(MFV_IOC_MAGIC, 0x37, unsigned int)/* HAL_POWER_T * */
