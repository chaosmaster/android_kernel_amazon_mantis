...
VAL_RESULT_T Wait_Lax_ISR(VAL_ISR_T *a_prParam, VAL_UINT32_T a_u4ParamSize);
...
VAL_RESULT_T eVideoLaxLockHW(VAL_HW_LOCK_T *a_prParam, VAL_UINT32_T  a_u4ParamSize);
...
VAL_RESULT_T eVideoLaxUnLockHW(VAL_HW_LOCK_T *a_prParam, VAL_UINT32_T  a_u4ParamSize);
