...
* for BOX (1/32KHZ) * MTK_NEC_SAPERIOD
************************************/
...
#define MTK_IR_SUPPORT_MOUSE_INPUT	1		/* Support mouse input, 0:no support 1:support */
#define MTK_IR_MOUSE_NEC_SWITCH_CODE 0x54	/* The switch code(Blue key) for IR input and Mouse input */
#define MTK_IR_MOUSE_NEC_WHEEL_UP 0x50	/* Code(Green key) for IR as mouse wheel up*/
#define MTK_IR_MOUSE_NEC_WHEEL_DOWN 0x16  /* Code(Yellow key) for IR as mouse wheel down*/
#ifdef CONFIG_MTK_IRRX_MOUSE_DRAG
#define MTK_IR_MOUSE_DRAG_MODE_DEFAULT	MTK_IR_AS_NORMAL_MOUSE
#define MTK_IR_NEC_DRAG_MOUSE_SWITCH_CODE 0x12	/* The drag mouse switch code(Red key) */
#endif
