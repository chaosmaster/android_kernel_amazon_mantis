...
static int mtk_ir_nec_init_hw(void)
{
	...
	if (ir_mode == MTK_IR_FACTORY) {
		...
		mtk_ir_pdata_nec.mouse_code.scanwheelup = MTK_IR_MOUSE_NEC_WHEEL_UP;
		mtk_ir_pdata_nec.mouse_code.scanwheeldown = MTK_IR_MOUSE_NEC_WHEEL_DOWN;
		...
		mtk_ir_pdata_nec.mouse_code.dragswitch = MTK_IR_NEC_DRAG_MOUSE_SWITCH_CODE;
#endif
