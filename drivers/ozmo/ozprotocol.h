...
/* Bit8 of index field in farewell report is now
 * used to indicate when to issure farewell report.
 * if bit gets set, driver sends farewell to
 * upper stack when presleep timer expires.
 */
#define OZ_FAREWELL_CONDITION		0x80
#define OZ_FAREWELL_INDEX_MASK		0x7F

#define OZ_FAREWELL_ON_SLEEP		0x80
#define OZ_FAREWELL_ON_KEEP_ALIVE	0x00
